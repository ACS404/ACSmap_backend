...
# Configure Flask Port, default to 8009 which is same as Docker setup
app.config['FLASK_PORT'] = int(os.environ.get('FLASK_PORT') or 8009)
...
# Add this after your CORS setup in __init__.py
@app.after_request
